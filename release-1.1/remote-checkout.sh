...
do
    eval ip=\$a$i
    echo ${ip}
    ssh -p 22 -i /home/datlv/Documents/deevo/key/dev-full-rights.pem ubuntu@${ip} 'cd /opt/gopath/src/github.com/deevotech/sc-network.deevo.io && git reset --hard && git checkout release-1.2 && git pull && exit;'
done
